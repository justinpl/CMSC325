    ...
    protected void paintComponent(Graphics g) {
        ...
        switch (frameNumber) {
            case 1: // First frame is unmodified.
                 ...
                 rotation = 0;
                break;
            case 2: // Translate -10 in x direction, Translate +12 in the y direction.
            	translateX = -10;
                translateY = +12;
                
                break;
            case 3: // Rotate 55 degrees counter clockwise.
                rotation = 55*Math.PI / 180.0;
                break;
            case 4: // Rotate 75 clockwise
                rotation = rotation-(75*Math.PI / 180.0);
                break;
            case 5: // Scale 3 times for the x component, scale 1.5 times for the y component
            	scaleX = 3.0;
                scaleY = 1.5;
                break;
            default:
